        ...
        <div className="flex flex-wrap *:shrink-0 h-[80vh] overflow-auto gap-5 shadow-xl shadow-cyan-500/10 hover:shadow-2xl hover:shadow-cyan-600/90 transition-shadow duration-300 xs:justify-center md:justify-evenly *:rounded-2xl *:p-4 text-cyan-900">
          {task.map((elem, idx) => {
            return (
              <div
                key={idx}
                className="h-[40vh] w-70 leading-tight bg-[url('https://static.vecteezy.com/system/resources/thumbnails/010/793/873/small/a-lined-note-paper-covered-with-transparent-tape-on-a-yellow-background-with-a-white-checkered-pattern-free-png.png')] bg-center bg-cover flex flex-col justify-between *:p-3"
              >
